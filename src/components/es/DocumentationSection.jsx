...
export default function DocumentationSection() {
  ...
  const docs = [
    {
      title: "Individual Taxpayer Registry (CPF)",
      icon: <IdCard className="w-12 h-12 mx-auto mb-2" />,
    },
    {
      title: "General Registration (RG)",
      icon: <User className="w-12 h-12 mx-auto mb-2" />,
    },
    {
      title: "Unified Health System (SUS)",
  ...
  return (
    <section className="relative bg-green-500 text-white py-20 px-6 overflow-hidden">
      {/* Background image on the left with fade-out */}
      <div
      ...
      <div className="relative z-10 max-w-7xl mx-auto text-center" data-aos="fade-up">
        ...
        >
          Here you will find guidance on where and how to get your documentation in our city.
        </motion.p>

        {/* Cards with sequential animation and AOS */}
