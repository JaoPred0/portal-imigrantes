...
const servicios = [
  ...
  "Comida Rápida Monarquía",
  "Comida Rápida de Boby",
  "Tiendas Minoristas del Mercado de Moda",
      ...
      <div className="relative z-10 px-6 py-12">
        ...
        >
          ...
          <p className="text-lg mt-3 text-white/90" data-aos="fade-up">
            Aquí encontrarás empresas con puertas abiertas para ofrecer oportunidades a inmigrantes.
          </p>
        </motion.div>
        ...
        <div
          ...
          data-aos="fade-left"
        >
          <p className="text-white">PRINCIPALES AGENCIAS DE EMPLEO</p>
        ...
        >
          <AnimatePresence>
            {busqueda && (
              ...
              >
                <span>Has buscado: <strong>{busqueda}</strong></span>
                <a
                  href="#"
        ...
        {/* Botón flotante opcional para compartir */}
        <div
