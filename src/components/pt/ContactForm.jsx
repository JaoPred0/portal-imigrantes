  ...
  return (
    <section className="min-h-screen flex items-start justify-center px-6 py-12 bg-white">
      <div
        ...
        data-aos="fade-up"
      >
        <h1 className="text-3xl font-extrabold mb-6" data-aos="fade-up">FALE CONOSCO</h1>

        <form className="space-y-4">
          <div data-aos="fade-up" data-aos-delay="100">
            <label className="block text-sm mb-1">Seu Nome (obrigatório)</label>
            <input
              type="text"
          ...
          <div data-aos="fade-up" data-aos-delay="200">
            <label className="block text-sm mb-1">Contato (obrigatório)</label>
            <input
              type="text"
              className="w-full border border-gray-300 px-3 py-2 rounded focus:outline-none focus:ring-2 focus:ring-green-600"
              required
          ...
          <div data-aos="fade-up" data-aos-delay="400">
            <label className="block text-sm mb-1">Sua mensagem</label>
            <textarea
